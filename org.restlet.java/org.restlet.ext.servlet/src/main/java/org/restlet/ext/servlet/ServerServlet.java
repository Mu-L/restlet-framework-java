...
public class ServerServlet extends HttpServlet {
	...
	protected void init(Application application) {
		if (application != null) {
			...
			if (applicationContext != null) {
				...
				for (Enumeration<String> enum1 = getServletContext().getInitParameterNames(); enum1
						.hasMoreElements();) {
					initParam = enum1.nextElement();
	...
	protected void init(Component component) {
		if (component != null) {
			...
			for (Enumeration<String> namesEnum = getServletContext().getAttributeNames(); namesEnum
					.hasMoreElements();) {
