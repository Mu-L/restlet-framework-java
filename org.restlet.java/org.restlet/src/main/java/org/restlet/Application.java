 ...
 * <ul>
 * <li>"connectorService" to declare necessary client and server
 * connectors.</li>
...
public class Application extends Restlet {
	 ...
	 * ClientResource. In general, instances of {@link Router} and {@link Filter}
	 * classes will be used. The default implementation returns a Restlet giving
	 * access to the the outbound service layer and finally to the
	 * {@link Context#getClientDispatcher()}.
	 * <p>
	 * This method is intended to be overridden by subclasses but in order to
	 * benefit from the outbound service filtering layer, the original outbound root
	 * must be careful attached again at the end of the user filtering layer.
	 * 
	...
	/**
	 * Sets the modifiable list of roles. This method clears the current list and
	 ...
	 * associated services. Finally, it clears the internal cache of annotations.
	 */
	@Override
