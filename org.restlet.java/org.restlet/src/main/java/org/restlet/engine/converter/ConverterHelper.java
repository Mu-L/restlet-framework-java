...
public abstract class ConverterHelper extends Helper {
	 ...
	 * @return The list of variants that can be converted from a given object class.
	 * @throws IOException
	 */
	...
	/**
	 * Returns the list of variants that can be converted from a given object class.
	 * The preferred variant should be set in first position.
	 * 
	 ...
	 */
	public abstract Representation toRepresentation(Object source, Variant target, Resource resource)
			throws IOException;
