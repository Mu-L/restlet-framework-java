...
public class CorsFilter extends Filter {
	 ...
	 * {@link #skippingResourceForCorsOptions} is true and if the current request
	 * use the OPTIONS method and is a CORS request.
	 * 
	 * @param request  The request to handle.
	 * @param response The response to update.
	 * @return The continuation status. Either {@link #CONTINUE} or {@link #SKIP} or
	 *         {@link #STOP}.
	 */
	@Override
	protected int beforeHandle(Request request, Response response) {
		if (skippingResourceForCorsOptions && Method.OPTIONS.equals(request.getMethod())
	 ...
	 * only if {@link #allowAllRequestedHeaders} is false.
	 * 
