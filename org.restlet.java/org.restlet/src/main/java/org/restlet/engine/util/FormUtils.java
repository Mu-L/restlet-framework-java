...
public class FormUtils {
	 ...
	 * @param decode       Indicates if the parameters should be decoded using the
	 *                     given character set.
	 * @return The parameter.
	 * @throws IOException
	 */
	public static Parameter getFirstParameter(String query, String name, CharacterSet characterSet, char separator,
	 ...
	 * @param separator    The separator character to append between parameters.
	 * @param decode       Indicates if the parameters should be decoded using the
	 *                     given character set. s * @return The parameter value or
	 *                     list of values.
	 * @throws IOException If the parameters could not be read.
	 */
	public static Object getParameter(String query, String name, CharacterSet characterSet, char separator,
			boolean decode) throws IOException {
	 ...
	 * @param characterSet     The supported character encoding.
	 * @param separator        The separator character to append between parameters.
	 * @param decode           Indicates if the parameters should be decoded using
	 *                         the given character set.
	 * @throws IOException If the parameters could not be read.
	 */
	public static void getParameters(String parametersString, Map<String, Object> parameters, CharacterSet characterSet,
		...
		if (post != null) {
			if (post.isAvailable()) {
				...
				try {
					...
					Context.getCurrentLogger().log(Level.WARNING, "Unable to create a form reader. Parsing aborted.",
							ioe);
				}
