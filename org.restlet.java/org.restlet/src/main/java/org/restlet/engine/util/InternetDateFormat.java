...
public class InternetDateFormat extends DateFormat {
	...
	/**
	 * Returns the current date and time as an RFC 3339 date/time string using the
	 * UTC (Z) time zone.
	 * 
	...
	/**
	 * Our private parse utility that parses the string, clears the calendar, and
	 * then sets the fields.
	 * 
	 * @param s   the string to parse
	 * @param cal the calendar object to populate
	 * @throws IllegalArgumentException if the string is not a valid RFC 3339
	 *                                  date/time string
	 */
	 ...
	 * Unlike the toString methods for Date and long, no additional variant of this
	 * method taking a time zone is provided since the time zone is built into the
	 * Calendar object.
	 * 
	...
	/**
	 * Converts the specified Date object to an RFC 3339 date/time string using the
	 * UTC (Z) time zone.
	 * 
	...
	/**
	 * Creates a new InternetDateFormat object from the specified Date object using
	 * the UTC (Z) time zone.
	 * 
	 * @param date the Date object
	...
	/**
	 * Creates a new InternetDateFormat object from the specified millisecond time
	 ...
	 * The specified calendar object is cloned thereby isolating this
