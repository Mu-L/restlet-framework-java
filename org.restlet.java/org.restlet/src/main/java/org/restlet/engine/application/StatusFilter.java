...
public class StatusFilter extends Filter {
	...
	/**
	 * Allows filtering after its handling by the target Restlet. If the status is
	 * not set, set {@link org.restlet.data.Status#SUCCESS_OK} by default.
	 * 
	...
	/**
	 * Handles the call by distributing it to the next Restlet. If a throwable is
	 * caught, the
