...
public abstract class AnnotationInfo {
	 ...
	 * Constructor.
	 * 
	 * @param javaClass       The annotated Java class or parent Java class.
	 * @param javaMethod      The annotated Java method.
	 * @param annotationValue The annotation value.
	 */
	public AnnotationInfo(Class<?> javaClass, java.lang.reflect.Method javaMethod, String annotationValue) {
		super();
	...
	public String toString() {
		return "AnnotationInfo [javaMethod: " + javaMethod + ", javaClass: " + javaClass + ", value: " + annotationValue
				+ "]";
	}
