...
public class StringUtils {
	...
	/**
	 * Stores a list en entities and is able to return one given its numeric value
	 * or name.
	 *
	 * @author Thierry Boileau
	 */
	 ...
	 * @return The String encoded with the Ascii character set as an array of bytes.
	 */
	...
	/**
	 * Returns the given {@link String} according to the HTML 4.0 encoding rules.
	 *
	...
	/**
	 * Returns the given {@link String} decoded according to the HTML 4.0 decoding
	 * rules.
	 *
	 * @param str The {@link String} to decode.
	 * @return The given {@link String} decoded according to the HTML 4.0 decoding
	 *         rules.
	 */
	 ...
	 * @return List of tokens.
	 */
	public static List<String> splitAndTrim(String stringToSplit, String splitCharacter) {
