...
public class Directory extends Finder {
	 ...
	 *                characters at the beginning, for example:
	 *                file:///c:/dir/file<br>
	 *                <br>
	 ...
	 * is found.
	 * 
	 * @return True if the display of directory listings is allowed when no index
	 *         file is found.
	 */
	 ...
	 * is found.
	 * 
	 * @param listingAllowed True if the display of directory listings is allowed
	 *                       when no index file is found.
	 */
	 ...
	 * true.
	 * 
	 * @param negotiatingContent True if the best content is automatically
	 *                           negotiated.
	 */
	...
	/**
	 * Sets the reference comparator based on the more friendly "Alphanum Algorithm"
	 * created by David Koelle. The internal implementation used is based on an
	 * optimized public domain implementation provided by Rob Heittman from the
	 * Solertium Corporation.
	 * 
	 * @see <a href="http://www.davekoelle.com/alphanum.html">The original Alphanum
	 *      Algorithm from David Koelle</a>
	 * @see #setComparator(Comparator)
	 */
