...
public class CorsService extends Service {
	 ...
	 * into the 'Access-Control-Allow-Headers' response header. If false, use
	 * {@link #allowedHeaders}. Default is true.
	 */
	private boolean allowingAllRequestedHeaders = true;

	/**
	 * The set of methods allowed by default, used when
	 * {@link #skippingResourceForCorsOptions} is turned on. By default: GET, PUT,
	 * POST, DELETE, PATCH.
	 */
	private Set<Method> defaultAllowedMethods = new HashSet<>(
			Arrays.asList(Method.GET, Method.POST, Method.PUT, Method.DELETE, Method.PATCH));

	/** The value of 'Access-Control-Expose-Headers' response header. */
	private Set<String> exposedHeaders = null;

	/**
	 * The value of 'Access-Control-Max-Age' response header. Default is that the
	 * header is not set.
	 */
	 ...
	 * methods cf {@link #getDefaultAllowedMethods()}. Default is false.
	 */
	...
	public Filter createInboundFilter(Context context) {
		return new CorsFilter().setAllowedCredentials(allowedCredentials).setAllowedOrigins(allowedOrigins)
				.setAllowingAllRequestedHeaders(allowingAllRequestedHeaders).setAllowedHeaders(allowedHeaders)
				.setExposedHeaders(exposedHeaders).setSkippingResourceForCorsOptions(skippingResourceForCorsOptions)
				.setDefaultAllowedMethods(getDefaultAllowedMethods()).setMaxAge(maxAge);
	}
	 ...
	 * {@link #skippingResourceForCorsOptions} is turned on.
	 * 
	 * @return The list of methods allowed by default, used when
	 *         {@link #skippingResourceForCorsOptions} is turned on.
	 */
	 ...
	 * cached in a preflight result cache.<br>
	 ...
	 * 
	 * @return True, if the 'Access-Control-Allow-Credentials' header will be added.
	 */
	 ...
	 * header. If false, use {@link #allowedHeaders}.
	 * 
	 ...
	 * 
	 * @return True if the filter does not call the server resource for OPTIONS
	 *         method of CORS request.
	 */
	 ...
	 * If true, adds 'Access-Control-Allow-Credentials' header.
	 * 
	 * @param allowedCredentials True to add the 'Access-Control-Allow-Credentials'
	 *                           header.
	 */
	...
	/**
	 * Sets the value of the 'Access-Control-Allow-Headers' response header. Used
	 * only if {@link #allowingAllRequestedHeaders} is false.
	 * 
	 * @param allowedHeaders The value of 'Access-Control-Allow-Headers' response
	 *                       header.
	 */
	 ...
	 * 
	 * @param allowedOrigins The value of 'Access-Control-Allow-Origin' header.
	 */
	 ...
	 * {@link #allowedHeaders}.
	 * 
	 * @param allowingAllRequestedHeaders True to copy the value of
	 ...
	 * {@link #skippingResourceForCorsOptions} is turned on.
	 * 
	 * @param defaultAllowedMethods The list of methods allowed by default, used
	 *                              when {@link #skippingResourceForCorsOptions} is
	 *                              turned on.
	 */
	 ...
	 * 
	 * @param exposedHeaders The value of 'Access-Control-Expose-Headers' response
	 *                       header.
	 */
	 ...
	 * 
	 * @param maxAge The value of 'Access-Control-Max-Age' response header.
	 */
	 ...
	 * 
	 * @param skipResourceForCorsOptions True if the filter does not call the server
