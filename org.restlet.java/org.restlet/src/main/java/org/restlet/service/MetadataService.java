...
public class MetadataService extends Service {
	...
	/**
	 * Constructor. Sets the default language to {@link Language#ENGLISH_US}, the
	 * default encoding to {@link Encoding#IDENTITY} (no encoding) and the default
	 * media type to {@link MediaType#APPLICATION_OCTET_STREAM}. It also calls the
	 * {@link #addCommonExtensions()} method.
	 */
	...
	/**
	 * Maps an extension to some metadata (media type, language or character set) to
	 * an extension.
	 * 
	...
	/**
	 * Returns all the character sets associated to this extension. It returns null
	...
	/**
	 * Returns all the languages associated to this extension. It returns null if
	...
	/**
	 * Returns all the media types associated to this extension. It returns null if
	 * the extension was not declared.
	 * 
	 * @param extension The extension name without any delimiter.
	...
	/**
	 * Returns all the metadata associated to this extension. It returns null if the
	...
	/**
	 * Returns the character set associated to this extension. It returns null if
	 * the extension was not declared of it is corresponds to another type of
	 * medatata such as a media type. If several metadata are associated to the same
	...
	/**
	 * Returns the mediatype associated to this extension. It returns null if the
	 * extension was not declared of it is corresponds to another type of medatata
	 * such as a language. If several metadata are associated to the same extension
	 * (ex: 'xml' for both 'text/xml' and 'application/xml') then only the first
	 * matching metadata is returned.
	 * 
	 * 
	 * @param extension The extension name without any delimiter.
	 ...
	 * extension was not declared. If several metadata are associated to the same
	 * extension (ex: 'xml' for both 'text/xml' and 'application/xml') then only the
	 * first matching metadata is returned.
	 * 
	 * @param extension The extension name without any delimiter.
	 ...
	 * 
	 * @param defaultCharacterSet The default character set for local
	 *                            representations.
	 */
