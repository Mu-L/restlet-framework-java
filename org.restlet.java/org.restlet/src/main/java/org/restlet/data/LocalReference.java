...
public final class LocalReference extends Reference {
	/**
	 * The resources will be resolved from the classloader associated with the local
	 * class. This is the same as the {@link #CLAP_CLASS} authority. Examples:
	 * clap:///rootPkg/subPkg/myClass.class or clap:///rootPkg/file.html
	 * 
	...
	/**
	 * The resources will be resolved from the classloader associated with the local
	 * class. This is the default CLAP authority. Examples:
	 * clap://class/rootPkg/subPkg/myClass.class or clap://class/rootPkg/file.html
	 * or clap:///rootPkg/file.html
	 * 
	 * @see java.lang.Class#getClassLoader()
	 */
	 ...
	 * Example riap://application/myPath/myResource
	 */
	...
	/**
	 * Normalize a path by converting all the system-dependent separator characters
	 * to the standard '/' separator character.
	 * 
	...
	/**
	 * Gets the local file corresponding to the reference. Only URIs referring to
	 * the "localhost" or to an empty authority are supported.
	 * 
