...
public class Range {
	 ...
	 * {@value #INDEX_LAST} (-1), then it defines the end of the range. The default
	 * value is {@link #INDEX_FIRST} (0), starting at the first byte.
	 */
	...
	/**
	 * Size of the range in number of bytes (or range unit). If the size is the
	...
	/**
	 * Constructor defining a range starting on the first byte and with the given
	 * size.
	 * 
	 ...
	 * @param index        Index from which to start the range
	 * @param size         Size of the range in number of bytes.
	 * @param instanceSize Size of the instance in number of bytes.
	 * @param unitName     Unit of the range.
	 */
	...
	public boolean equals(Object object) {
		return (object instanceof Range) && ((Range) object).getIndex() == getIndex()
				&& ((Range) object).getSize() == getSize();
	}

	/**
	 * Returns the index from which to start the range. If the index is superior or
	 * equal to zero, the index will define the start of the range. If its value is
	 * {@value #INDEX_LAST} (-1), then it defines the end of the range. The default
	 * value is {@link #INDEX_FIRST} (0), starting at the first byte.
	 * 
	...
	/**
	 * Returns the size of the range in number of bytes. If the size is the maximum
	 ...
	 * 
	 * @param instanceSize The total size of the instance.
	 */
	 ...
	 * 
	 * @param unitName The name of the range unit.
	 */
