...
public final class Method implements Comparable<Method> {
	...
	/**
	 * Creates a duplicate of the source resource, identified by the Request-URI, in
	 * the destination resource, identified by the URI in the Destination header.
	 * 
	...
	/**
	 * Used to take out a lock of any access type on the resource identified by the
	 * request URI.
	 * 
	...
	/**
	 * Logical equivalent of a copy, followed by consistency maintenance processing,
	...
	/**
	 * Removes the lock identified by the lock token from the request URI, and all
