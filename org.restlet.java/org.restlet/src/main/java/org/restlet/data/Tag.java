 ...
 * @see <a href=
 *      "http://www.w3.org/Protocols/rfc2616/rfc2616-sec3.html#sec3.11">HTTP
 *      Entity Tags</a>
 * @see <a href=
 *      "http://www.w3.org/Protocols/rfc2616/rfc2616-sec13.html#sec13.3.2">HTTP
...
public final class Tag {
	...
	/**
	 * Default constructor. The opaque tag is set to null and the weakness indicator
	 * is set to true.
	 */
	public Tag() {
		this(null, true);
