...
public final class Encoding extends Metadata {
	...
	public static final Encoding DEFLATE_NOWRAP = new Encoding("deflate-no-wrap",
	 ...
	 * true if both encodings are equal or if the given encoding is within the range
	 * of the current one. For example, ALL includes all encodings. A null encoding
