 ...
 * useful for resources identified by URNs or for Web proxies or Web
 * caches.</li>
...
public class VirtualHost extends Router {
	 ...
	 * virtual host won't have a proper context set. In general you will prefer to
	...
	/**
	 * Constructor. Accepts all incoming requests by default, use the set methods to
	 * restrict the matchable patterns.
	 * 
	 ...
	 * @see java.util.regex.Pattern
	 */
	public VirtualHost(Context parentContext, String hostDomain, String hostPort, String hostScheme,
			String resourceDomain, String resourcePort, String resourceScheme, String serverAddress,
			String serverPort) {
	 ...
	 * 
	 * In addition to super class behavior, this method will set the context of the
	 * target if it is empty by creating a protected context via the
	 ...
	 * 
	 * In addition to super class behavior, this method will set the context of the
	 * finder by creating a protected context via the
	 * {@link Context#createChildContext()} method.
	 * 
	...
	/**
	 * Returns the hostRef scheme to match. See the {@link java.util.regex.Pattern}
	...
	/**
	 * Returns the listening server address. See the {@link java.util.regex.Pattern}
	 * class for details on the syntax.
	 * 
	...
	/**
	 * Returns the listening server port. See the {@link java.util.regex.Pattern}
	 * class for details on the syntax.
	 * 
	...
	/**
	 * Sets the hostRef host port to match. See the {@link java.util.regex.Pattern}
	 * class for details on the syntax.
	 * 
	...
	/**
	 * Sets the resourceRef scheme to match. See the {@link java.util.regex.Pattern}
	 * class for details on the syntax.
	 * 
	...
	/**
	 * Sets the listening server address. See the {@link java.util.regex.Pattern}
	 * class for details on the syntax.
	 * 
	...
	/**
	 * Sets the listening server port. See the {@link java.util.regex.Pattern} class
