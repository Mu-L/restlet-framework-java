...
public final class Variable {
	...
	/**
	 * Indicates if the value is fixed, in which case the "defaultValue" property is
	 * always used.
	 */
	...
	/**
	 * Default constructor. Type is TYPE_ALL, default value is "", required is true
	 * and fixed is false.
	 */
	public Variable() {
	 ...
	 * 
	 * @param type         The type of variable. See TYPE_* constants.
	 * @param defaultValue The default value to use if the key couldn't be found in
	 *                     the model.
	 ...
	 * 
	 * @param type             The type of variable. See TYPE_* constants.
	 * @param defaultValue     The default value to use if the key couldn't be found
	 *                         in the model.
	 * @param required         Indicates if the variable is required or optional.
	 * @param fixed            Indicates if the value is fixed, in which case the
	 *                         "defaultValue" property is always used.
	 ...
	 */
	public Variable(int type, String defaultValue, boolean required, boolean fixed, boolean decodingOnParse,
	 ...
	 * 
	 * @return The default value to use if the key couldn't be found in the model.
	 */
	 ...
	 * is always used.
	 * 
	 * @return True if the value is fixed, in which case the "defaultValue" property
	 *         is always used.
	 */
	 ...
	 * Indicates if the parsed value must be decoded.
	 * 
	 * @param decodingOnParse True if the parsed value must be decoded, false
	 *                        otherwise.
	 */
	 ...
	 * Indicates if the formatted value must be encoded.
	 * 
	 * @param encodingOnFormat True if the formatted value must be encoded, false
	 *                         otherwise.
	 */
