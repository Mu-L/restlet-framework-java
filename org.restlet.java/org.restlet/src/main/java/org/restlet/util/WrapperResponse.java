...
public class WrapperResponse extends Response {
	...
	/**
	 * Returns the set of methods allowed on the requested resource. This property
	 * only has to be updated when a status CLIENT_ERROR_METHOD_NOT_ALLOWED is set.
	 * 
	 ...
	 * information relative to the message. This is an easier alternative to the
	 * creation of a wrapper instance around the whole message.<br>
	 * <br>
	 * 
	 ...
	 * </tr>
	 * </table>
	 * Adding standard HTTP headers is forbidden because it could conflict with the
	 * connector's internal behavior, limit portability or prevent future
	 * optimizations.</td>
	 * 
	 ...
	 * be met: the content must exists and have some available data.
	 * 
