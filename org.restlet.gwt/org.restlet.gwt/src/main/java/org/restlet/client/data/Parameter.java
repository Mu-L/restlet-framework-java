...
public class Parameter implements Comparable<Parameter>, NamedValue<String> {
     ...
     * (non-Javadoc)
     * 
     * @see org.restlet.client.data.NamedValue#compareTo(org.restlet.client.data.Parameter)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.restlet.client.data.NamedValue#getName()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.restlet.client.data.NamedValue#getValue()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.restlet.client.data.NamedValue#setName(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.restlet.client.data.NamedValue#setValue(java.lang.String)
     */
