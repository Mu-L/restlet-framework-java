...
import static org.restlet.client.engine.header.HeaderUtils.isCarriageReturn;
import static org.restlet.client.engine.header.HeaderUtils.isComma;
import static org.restlet.client.engine.header.HeaderUtils.isCommentText;
import static org.restlet.client.engine.header.HeaderUtils.isDoubleQuote;
import static org.restlet.client.engine.header.HeaderUtils.isLineFeed;
import static org.restlet.client.engine.header.HeaderUtils.isLinearWhiteSpace;
import static org.restlet.client.engine.header.HeaderUtils.isQuoteCharacter;
import static org.restlet.client.engine.header.HeaderUtils.isQuotedText;
import static org.restlet.client.engine.header.HeaderUtils.isSemiColon;
...
public class HeaderReader<V> {
    ...
    private static <NV extends NamedValue<String>> NV createNamedValue(
         ...
         if (org.restlet.client.data.Parameter.class.equals(resultClass)) {
         return (NV) new org.restlet.client.data.Parameter(name, value);
         } else if (org.restlet.client.data.Cookie.class.equals(resultClass)) {
         return (NV) new org.restlet.client.data.Cookie(name, value);
         } else if (org.restlet.client.data.CookieSetting.class.equals(resultClass))
         {
         return (NV) new org.restlet.client.data.CookieSetting(name, value);
         } else if (org.restlet.client.data.CacheDirective.class.equals(resultClass))
         {
         return (NV) new org.restlet.client.data.CacheDirective(name, value);
         } else if
         (org.restlet.client.data.Header.class.equals(resultClass)) {
         return (NV) new org.restlet.client.data.Header(name, value);
         }
         return null;
    }
